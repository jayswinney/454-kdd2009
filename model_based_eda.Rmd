...
varImpPlot(churn_rf, type = 2, main = 'Variable Importance')
```
...
The Random Forest classifier selects close to 200 predictor variables as having significant predictive value for Upsell. This is a very large number .  We do see that the Meandecrease in Gini Index is highest on including Var 126. This matches with the results from Decision tree that Var 126 has a higher predictor value.
