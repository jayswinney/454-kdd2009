...
# save the output
save(list = c('upsell.knnTrainPred'),
    file = 'models/upsell/upsell.knnTrainPred.RData')
...
# save the output
save(list = c('upsell.knnCalPred'),
    file = 'models/upsell/upsell.knnCalPred.RData')
...
# save the output
save(list = c('upsell.knnTestPred'),
    file = 'models/upsell/upsell.knnTestPred.RData')
