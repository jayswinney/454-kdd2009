...
```
```{r, echo = FALSE, fig.width = 8, fig.height=6, fig.cap='ROC Curve Appetency Models'}
a_roc
```
...
```{r, echo = FALSE, fig.width = 8, fig.height=6, fig.cap='ROC Curve Churn Models'}
c_roc
```
...
```{r, echo = FALSE, fig.width = 8, fig.height=6, fig.cap='ROC Curve Up-Sell Models'}
u_roc
```
